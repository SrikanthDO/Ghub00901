...
var Ghub00901 = angular.module('Ghub00901');
Ghub00901.service('Util', function($filter) {
...
Ghub00901.service('BSServiceUtil', function(AlertService, ExportService, BSService, Cache) {
...
Ghub00901.service('EmailService', function(AlertService, BSService) {
...
Ghub00901.service('CommentService', function(AlertService, BSService) {
...
Ghub00901.factory('ExportService', function($resource) {
...
Ghub00901.factory('BSService', function($resource) {
...
Ghub00901.service('AlertService', function(SweetAlert) {
...
Ghub00901.service('AppService', function(AlertService, BSServiceUtil, AlertService, Cache) {
...
Ghub00901.service('Cache', function() {
    var map;
